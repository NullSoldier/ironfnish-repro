...
exports.AddPeerResponseSchema = exports.AddPeerRequestSchema = void 0;
...
exports.AddPeerRequestSchema = yup
    .object({
    ...
    .defined();
exports.AddPeerResponseSchema = yup
    .object({
    added: yup.boolean().defined(),
    error: yup.string().optional(),
})
    .defined();
router_1.routes.register(`${router_1.ApiNamespace.peer}/addPeer`, exports.AddPeerRequestSchema, (request, node) => {
    ...
    const peer = peerManager.connectToWebSocketAddress({
        host,
        port: port || config_1.DEFAULT_WEBSOCKET_PORT,
        whitelist: !!whitelist,
        forceConnect: true,
    });
