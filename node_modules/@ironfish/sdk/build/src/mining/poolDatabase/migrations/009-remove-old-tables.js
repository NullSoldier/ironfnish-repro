...
class Migration009 extends migration_1.Migration {
    constructor() {
        super(...arguments);
        this.name = '009-remove-old-tables';
    }
    async forward(db) {
...
exports.default = Migration009;
//# sourceMappingURL=009-remove-old-tables.js.map