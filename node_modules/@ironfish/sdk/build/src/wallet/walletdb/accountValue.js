...
exports.AccountValueEncoding = exports.VIEW_KEY_LENGTH = exports.KEY_LENGTH = void 0;
...
exports.KEY_LENGTH = account_1.ACCOUNT_KEY_LENGTH;
...
class AccountValueEncoding {
    serialize(value) {
        ...
        if (value.createdAt) {
            const encoding = new headValue_1.NullableHeadValueEncoding();
    ...
    deserialize(buffer) {
        ...
        const spendingKey = hasSpendingKey ? reader.readBytes(exports.KEY_LENGTH).toString('hex') : null;
        const viewKey = reader.readBytes(exports.VIEW_KEY_LENGTH).toString('hex');
        const incomingViewKey = reader.readBytes(exports.KEY_LENGTH).toString('hex');
        const outgoingViewKey = reader.readBytes(exports.KEY_LENGTH).toString('hex');
