...
exports.RoundRobinQueue = void 0;
...
class RoundRobinQueue {
    ...
    constructor() {
        ...
        const enumKeys = Object.keys(workerMessage_1.WorkerMessageType)
            .map((v) => Number(v))
            .filter((v) => !isNaN(v));
...
exports.RoundRobinQueue = RoundRobinQueue;
//# sourceMappingURL=roundRobinQueue.js.map